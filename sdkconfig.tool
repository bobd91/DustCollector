...
#
# CONFIG_DUST_COLLECTOR_CONTROLLER is not set
CONFIG_DUST_COLLECTOR_TOOL=y
# CONFIG_DUST_COLLECTOR_GATE is not set
# CONFIG_DUST_COLLECTOR_VAC is not set
# end of Dust Collector Configuration
